...
public:
    ...
    void Sort_a(NodeType<ItemType>* location);
    void Sort_b(NodeType<ItemType>* location);
    void Sort();
    
protected:
    NodeType<ItemType>* MinLoc_a(NodeType<ItemType>* location, NodeType<ItemType>* minPtr);
