...
private:
  NodeTypeS<ItemType>* listData;
  int length;
  NodeTypeS<ItemType>* currentPos;
};
template<class ItemType>
struct NodeTypeS
{
...
{
  NodeTypeS<ItemType>* location;
  try
  {
    location = new NodeTypeS<ItemType>;
    delete location;
    return false;
  }
...
{
  NodeTypeS<ItemType>* newNode;  // pointer to node being inserted
  NodeTypeS<ItemType>* predLoc;  // trailing pointer
  NodeTypeS<ItemType>* location; // traveling pointer
  bool moreToSearch;
  ...
  newNode = new NodeTypeS<ItemType>;
  newNode->info = item;
...
{
    NodeTypeS<ItemType>* location = listData;
    NodeTypeS<ItemType>* tempLocation;
